...
!function(a) {
    ...
    return a.Control.Search = a.Control.extend({
        ...
        showAlert: function(a) {
            var b = this;
            return a = a || this.options.textErr, this._alert.style.display = "block", this._alert.innerHTML = a, clearTimeout(this.timerAlert), this.timerAlert = setTimeout(function() {
                b.hideAlert()
        ...
        _createInput: function(b, c) {
            ...
            return e.type = "text", e.size = this._inputMinSize, e.value = "", e.autocomplete = "off", e.autocorrect = "off", e.autocapitalize = "off", e.placeholder = b, e.style.display = "none", e.role = "search", e.id = e.role + e.type + e.size, d.htmlFor = e.id, d.style.display = "none", d.value = b, a.DomEvent.disableClickPropagation(e).on(e, "keyup", this._handleKeypress, this).on(e, "blur", this.collapseDelayed, this).on(e, "focus", this.collapseDelayedStop, this), e
        },
        ...
        _createTooltip: function(b) {
            ...
            return d.style.display = "none", a.DomEvent.disableClickPropagation(d).on(d, "blur", this.collapseDelayed, this).on(d, "mousewheel", function(b) {
                c.collapseDelayedStop(),
                a.DomEvent.stopPropagation(b)
            }, this).on(d, "mouseover", function(a) {
                c.collapseDelayedStop()
            }, this), d
        },
        ...
        _defaultFormatData: function(b) {
            ...
            if (a.Util.isArray(f))
                ...
                for (c in b)
                    g[d._getPath(b[c], e)] = a.latLng(d._getPath(b[c], f));
            return g
        },
        ...
        _recordsFromAjax: function(b, c) {
            ...
            return e.open("GET", f), e.onload = function() {
        ...
        _recordsFromLayer: function() {
            ...
            return this._layer.eachLayer(function(d) {
        ...
        _handleKeypress: function(a) {
            ...
            case 27:
                ...
                break;
            case 13:
                (1 == this._countertips || this.options.firstTipSubmit && this._countertips > 0) && -1 == this._tooltip.currentSelection && this._handleArrowSelect(1),
                this._handleSubmit();
                break;
            case 38:
            ...
            default:
                ...
                this._input.value.length >= this.options.minLength ? (clearTimeout(this.timerKeypress), this.timerKeypress = setTimeout(function() {
                    b._fillRecordsCache()
        ...
        _fillRecordsCache: function() {
            ...
            this.options.layer ? (this._recordsCache = this._recordsFromLayer(), b = this._filterData(this._input.value, this._recordsCache), this.showTooltip(b), a.DomUtil.removeClass(this._container, "search-load")) : (this.options.sourceData ? this._retrieveData = this.options.sourceData : this.options.url && (this._retrieveData = this.options.jsonpParam ? this._recordsFromJsonp : this._recordsFromAjax), this._curReq = this._retrieveData.call(this, d, function(d) {
                c._recordsCache = c._formatData.call(c, d),
                b = c.options.sourceData ? c._filterData(c._input.value, c._recordsCache) : c._recordsCache,
                c.showTooltip(b),
        ...
        _handleArrowSelect: function(b) {
            ...
            if (1 == b && this._tooltip.currentSelection >= c.length - 1)
                a.DomUtil.addClass(c[this._tooltip.currentSelection], "search-tip-select");
        ...
        _handleSubmit: function() {
            if (this._hideAutoType(), this.hideAlert(), this._hideTooltip(), "none" == this._input.style.display)
                this.expand();
        ...
        initialize: function(b, c) {
            ...
            a.Control.Search.prototype._isObject(this.options.circle) && (this._circleLoc = new a.CircleMarker(b, this.options.circle))
        },
        onAdd: function(b) {
